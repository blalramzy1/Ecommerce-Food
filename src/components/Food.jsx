...
const Food = () => {
  ...
  return ( 
    <div className='max-w-[1640px] ma-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-between'>
            ...
            <div>
                ...
                <div className='flex justify-between flex-wrap'>
                    ...
                    <button onClick={()=> filterType('burger')} className='m-1 border-orange-600 hover:bg-orange-600 hover:text-white'>Burguers</button>
                    ...
                    <button onClick={()=> filterType('chicken')} className='m-1 border-orange-600 hover:bg-orange-600 hover:text-white'>Chickens</button>
                </div>
            </div>
            <div>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4'>
                {foods.map((item,index)=>( 
                    <div key={index} className='border shadow-lg hover:scale-105 duration-300 rounded-t-xl'>
